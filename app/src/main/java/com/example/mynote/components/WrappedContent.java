 ...
 * @see  //h t t p ://stackoverflow.com/questions/549451/line-breaking-widget-layout-for-android
 * @license http://creativecommons.org/licenses/by-sa/2.5/
 *
 */
public class WrappedContent extends ViewGroup {

    private int line_height;

    public WrappedContent(Context context) {
        super(context);
    }

    public WrappedContent(Context context, AttributeSet attrs){
        super(context, attrs);
    }
